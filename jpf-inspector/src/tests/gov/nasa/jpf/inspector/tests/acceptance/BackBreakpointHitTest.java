...
public class BackBreakpointHitTest extends CorrectOutputAbstractTest {

  public BackBreakpointHitTest(CorrectOutputTestCase testCase) {
    super(testCase);
  }
  ...
  public static Iterable<?> data() {
     return Arrays.asList(
          getCase("features/backstep", "bbhit_ok"),
          getCase("features/backstep", "bbhit_errors")
     );
  }
}
